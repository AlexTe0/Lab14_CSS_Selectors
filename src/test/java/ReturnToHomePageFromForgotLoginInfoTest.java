...
public class ReturnToHomePageFromForgotLoginInfoTest {
    ...
    @Test
    public void returnToHomePageFromForgotLoginInfo(){
        driver.findElement(By.cssSelector("#loginPanel a")).click();
